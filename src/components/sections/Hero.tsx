...
export function Hero() {
	return (
		<section className="bg-background relative mt-[2.5vh] flex min-h-[85vh] items-center justify-center overflow-hidden pt-16 pb-[10vh]">
			<HeroBackground />
			...
			<div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
				...
				<BlurFade delay={0.4}>
					<p className="text-foreground-secondary mx-auto mt-6 max-w-2xl text-lg leading-relaxed md:text-xl">
						...
						sponsors on complex collections.
					</p>
				</BlurFade>
